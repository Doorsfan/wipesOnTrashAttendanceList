      ...
      for (const browserType of ['firefox']) {
            ...
            if(!pageHolder.browserOpen){
                ...
                if(dateOfRaid == ""){
                    ...
                    //520, 370 back button
                    if(day > 1){ //LOOPS BACK TO CLOSEST MONDAY WHEN OPENING NEW BROWSER FOR FIRST TIME
                        await delay(1000);
                        await page.mouse.click(575, 500); //The monday element
                    ...
                    if(day == 1){
                        ...
                        await page.mouse.click(1100, 366); //Week list
                        await delay(1000);
                        await page.mouse.click(475, 500); //The sunday element, Sunday is 475, 500
                    ...
                    if(day == 0){
                        ...
                        await page.mouse.click(1100, 366); //Week list
                        await delay(1000);
                        await page.mouse.click(520, 370); //Back button - Works
                        await delay(1000);
                        await page.mouse.click(575, 500); //The Monday Element
                        server_js.isSunday = false;
                        server_js.isMonday = true;
